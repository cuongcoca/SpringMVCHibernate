...
app.controller('myCtrl', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.viewFullImg = function (fileName) {
        $scope.fileNameDetail = fileName;
        $("#modalDetail").modal("show");
    }

    $scope.dowloadImg = function (fileName) {
        // window.location.href = preUrl + "/upload-file/dowload/" + fileName;
        window.open(preUrl + "/upload-file/dowload/" + fileName, "_blank");
    }
